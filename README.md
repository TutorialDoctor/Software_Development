...
First you will **learn** how to program using the **Python** (version **2.7**) language. Then you will **play** with various programs. Next you get links to **resources**. Lastly you **create** a video **games** using the Godot game engine API, a **website** using html, css, and javascript, and a few **databases** using **sqlite3** and Python.
